...
<td width="400">
<p align="center"><b><font color="white" face="Arial Narrow" size="2">Test Data</font></b></p>
</td>
<td width="400">
...
<td width="200">
<xsl:choose>
	<xsl:when test="testdata='-'">
		<p align="center"><font face="Verdana" size="2"><xsl:value-of select="testdata"/></font></p>
	</xsl:when>
	 <xsl:otherwise>
		<p align="left"><font face="Verdana" size="2"><xsl:value-of select="testdata"/></font></p>
	 </xsl:otherwise>
...
<tr bgcolor ="blue">
<td width="400">
<p align="center"><b><font color="white"  size="2" face= "Verdana">No. Of Verification Points: <xsl:value-of select="teststeps/checkpoints/total"/></font></b></p>
</td>
<td width="400">
<p align="center"><b><font color="white"  size="2" face= "Verdana">Passed: <xsl:value-of select="teststeps/checkpoints/passed"/></font></b></p>
</td>
<td width="400">
<p align="center"><b><font color="white"  size="2" face= "Verdana">Failed: <xsl:value-of select="teststeps/checkpoints/failed"/></font></b></p>
</td>
</tr>
</table>
