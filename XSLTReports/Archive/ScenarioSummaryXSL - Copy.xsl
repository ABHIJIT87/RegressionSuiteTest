...
<td COLSPAN = "2" bgcolor ="#C6D0D1">
<p align="center"><b><font color="#687C7D" size="2" face= "Verdana"> Date: <xsl:value-of select="scenariosummary/starttime"/></font></b></p>
</td>

<td COLSPAN = "4" bgcolor = "#C6D0D1">
<p align="center"><b><font color="#687C7D" size="2" face= "Verdana"> Total Execution Time: <xsl:value-of select="scenariosummary/totalexecutiontime"/></font></b></p>
</td>
...
<td width="400">
<p align="justify"><b><font color="#687C7D" size="2" face= "Verdana">Passed : <xsl:value-of select="scenariosummary/summary/passed"/>
</font></b></p></td>

<td width="400">
<p align="justify"><b><font color="#687C7D" size="2" face= "Verdana">Failed : <xsl:value-of select="scenariosummary/summary/failed"/>
</font></b></p></td>
</tr>
